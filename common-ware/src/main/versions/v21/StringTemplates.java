...
// java --source 21 --enable-preview src/main/versions/v21/StringTemplates.java
...
public class StringTemplates {
    ...
    public static void main(String[] args) {
        ...
        // problem
        final String firstName = " Roy' OR p.first_name = ' Roy_";
        ...
        CartItem[] cartItems = new CartItem[] {
          new CartItem("Coffee", 5.65, 5),
          new CartItem("Latte", 7.20, 3),
          new CartItem("Cappuccino", 8.60, 1),
        };
