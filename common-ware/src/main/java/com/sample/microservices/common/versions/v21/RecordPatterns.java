...
public class RecordPatterns {
    ...
    public static void main(String[] args) {
        String obj = "Welcome Record Patterns!";
    ...
    //The pattern variable p is used here solely to invoke the accessor methods x()
    // and y(), which return the values of the components x and y.
    // (In every record class there is a one-to-one correspondence between
    // its accessor methods and its components.)
    // It would be better if the pattern could not only test
    // whether a value is an instance of Point
    // but also extract the x and y components from the value directly,
    // invoking the accessor methods on our behalf, which is what Java 21 can do.
