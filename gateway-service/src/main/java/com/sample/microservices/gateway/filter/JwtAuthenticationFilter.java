...
import com.sample.microservices.gateway.service.JwtService;
import com.sample.microservices.gateway.service.RedisService;
...
public class JwtAuthenticationFilter implements WebFilter {
	...
	public Mono<Void> filter(ServerWebExchange exchange, WebFilterChain chain) {
        ...
        if (jwt != null) {
            ...
            String comparedJwtInRedis = this.redisService.get(key); 
